...
Sprite Background(background),Background1(background),Racer(racer),Candy1(candy1),Candy2(candy2),Candy3(candy3),Obs1(obs1),
 ...
 //Sprite Candy4(ballon1), Candy5(ballon1), Candy6(ballon1), Candy4p(ballon1), Candy5p(ballon1), Candy6p(ballon1),Obs4(obs1),Obs5(obs2),Obs6(obs3),Obs4p(obs1),Obs5p(obs2),Obs6p(obs3);
  ...
  //lEVEL3
    ...
    Font fstart;
    fstart.loadFromFile("resources/DeliusSwashCaps-Regular.ttf");
    ...
    Font fhelp;
    fhelp.loadFromFile("resources/DeliusSwashCaps-Regular.ttf");
   ...
   if(gamelevel==2){
    ...
    if(gamelevel==3){
        ...
        Candy3p.move(-8,0);
         ...
         if(Obs1.getPosition().x<-1020) Obs1.setPosition(200,350);
         if(Obs2.getPosition().x<-1020) Obs2.setPosition(800,350);
         if(Obs3.getPosition().x<-1020) Obs3.setPosition(1300,350);
         if(Obs1p.getPosition().x<-1020) Obs1p.setPosition(1800,350);
         if(Obs2p.getPosition().x<-1020) Obs2p.setPosition(2300,350);
         if(Obs3p.getPosition().x<-1020) Obs3p.setPosition(2700,350);

         if(Candy1.getPosition().x<-1020) Candy1.setPosition(600,350);
         if(Candy2.getPosition().x<-1020) Candy2.setPosition(1100,350);
         if(Candy3.getPosition().x<-1020) Candy3.setPosition(1600,350);

         if(Candy1p.getPosition().x<-1020) Candy1p.setPosition(3100,350);
         if(Candy2p.getPosition().x<-1020) Candy2p.setPosition(3650,350);
         if(Candy3p.getPosition().x<-1020) Candy3p.setPosition(4000,350);
